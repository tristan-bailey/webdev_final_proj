defmodule FinalProjectWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FinalProjectWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FinalProjectWeb.Gettext, "errors", msg, opts)
    end
  end
